...
public final class Lexer202320 {
  ...
  public static Object initialize() {
    ...
    $try:try {
      ...
      $line=253;
      ((gold.structures.map.GHashTableMap)translation).put("drop",'g');
      $line=254;
      ...
      $line=260;
      ((gold.structures.map.GHashTableMap)translation).put("leap",'a');
      $line=261;
      ((gold.structures.map.GHashTableMap)translation).put("walk",'w');
      $line=266;
      ...
      $line=270;
      ((gold.structures.map.GHashTableMap)translation).put("times",'m');
      $line=273;
