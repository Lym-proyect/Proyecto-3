...
public final class Lexer202320 {
  ...
  public static Object initialize() {
    ...
    $try:try {
      ...
      $line=221;
      keyWords=$cast(ISet.class,$fix(GCollections.asSet("walk","right","turn","turnto","north","IdL","IdU","Num","defVar","defProc","jump","leap","drop","get","grab","letGo","nop","if","else","while","repeat","times","facing","can","not","front","left","back","south","west","east","around")));
      $line=222;
      ...
      $line=241;
      ((gold.structures.map.GHashTableMap)translation).put("leap",'L');
      $line=242;
      ((gold.structures.map.GHashTableMap)translation).put("drop",'D');
      $line=243;
      ((gold.structures.map.GHashTableMap)translation).put("get",'G');
      $line=244;
      ((gold.structures.map.GHashTableMap)translation).put("grab",'B');
      $line=245;
      ((gold.structures.map.GHashTableMap)translation).put("letGo",'&');
      $line=246;
      ((gold.structures.map.GHashTableMap)translation).put("nop",'O');
      $line=247;
      ((gold.structures.map.GHashTableMap)translation).put("if",'F');
      $line=248;
      ...
      $line=251;
      ((gold.structures.map.GHashTableMap)translation).put("times",'S');
      $line=252;
      ((gold.structures.map.GHashTableMap)translation).put("facing",'|');
      $line=253;
