// DO NOT EDIT THIS FILE! IT IS AUTOMATICALLY GENERATED FROM FILE "src/Lexer202320.gold"
import gold.*;
...
public final class Lexer202320 {
  ...
  static {
    ...
    $try:try {
      ...
      $rethrow($throwable,Lexer202320.class,null,$line);
    }
  }
  ...
  public static Object chars(Object string) {
    ...
    $try:try {
      ...
      $rethrow($throwable,Lexer202320.class,"chars",$line);
    }
    return $result;
  }
  public static Object charsStrings(Object strings) {
    ...
    $try:try {
      ...
      $v6:for (Object s:GCollections.unmodifiableCollection(strings)) {
        $v5.union(GCollections.unmodifiableSet(((java.lang.Iterable)(Lexer202320.chars(s)))));
      }
      $result=$v5;
      if (true) break $try;
      $line=33;
      ...
      $rethrow($throwable,Lexer202320.class,"charsStrings",$line);
    }
    return $result;
  }
  public static Object elements(Object array) {
    ...
    $try:try {
      ...
      $rethrow($throwable,Lexer202320.class,"elements",$line);
    }
    return $result;
  }
  public static Object prefixes(Object string) {
    ...
    $try:try {
      ...
      $rethrow($throwable,Lexer202320.class,"prefixes",$line);
    }
    return $result;
  }
  public static Object splits(Object string) {
    ...
    $try:try {
      ...
      $rethrow($throwable,Lexer202320.class,"splits",$line);
    }
    return $result;
  }
  public static Object allPrefixes(Object strings) {
    ...
    $try:try {
      ...
      $v20:for (Object s:GCollections.unmodifiableCollection(strings)) {
        $v19.union(GCollections.unmodifiableSet(((java.lang.Iterable)(Lexer202320.prefixes(s)))));
      }
      $result=$v19;
      if (true) break $try;
      $line=40;
      ...
      $rethrow($throwable,Lexer202320.class,"allPrefixes",$line);
    }
    return $result;
  }
  public static Object translationGet(Object q) {
    ...
    $try:try {
      ...
      $rethrow($throwable,Lexer202320.class,"translationGet",$line);
    }
    return $result;
  }
  public static Object runLexer(Object M, Object input) {
    ...
    $try:try {
      ...
      $rethrow($throwable,Lexer202320.class,"runLexer",$line);
    }
    return $result;
  }
    ...
    $try:try {
      ...
      if ($opMembrY(q,allSymbols)) {
        ...
        if ($opLessqY($opAbsolY(q),1)) {
          ...
          $line=56;
          for (Object $v21:GCollections.unmodifiableCollection(Lexer202320.splits(q))) {
            java.util.Iterator $v22=GCollections.unmodifiableCollection($v21).iterator();
            Object s=$v22.next();
            Object t=$v22.next();
            $line=57;
            if ((!$bool(Lexer202320.problems($cast(java.lang.String.class,s)))&&!$bool(Lexer202320.problems($cast(java.lang.String.class,t))))) {
              $line=57;
              $result=false;
              if (true) break $try;
            }
      ...
      $rethrow($throwable,Lexer202320.class,"problems",$line);
    }
    return $result;
  }
    ...
    $try:try {
      ...
      if ($opEqualY(n,0)) {
        ...
        if ($opMembrY(q,allSymbols)) {
          ...
          $line=73;
          $result=Lexer202320.translationGet(q);
          if (true) break $try;
        }
        else {
          $line=74;
          if ($opEqualY(n,1)) {
            ...
            $line=76;
            for (Object $v23:GCollections.unmodifiableCollection(Lexer202320.splits(q))) {
              java.util.Iterator $v24=GCollections.unmodifiableCollection($v23).iterator();
              Object s=$v24.next();
              Object t=$v24.next();
              $line=77;
              x=$fix(Lexer202320.translationPreOps(s));
              $line=78;
              y=$fix(Lexer202320.translationPreOps(t));
              $line=79;
      ...
      $rethrow($throwable,Lexer202320.class,"translationPreOps",$line);
    }
    return $result;
  }
  public static ITransducer createLexer() {
    ...
    $try:try {
      $line=91;
      Lexer202320.initialize();
      $line=93;
      preOps=$cast(ISet.class,$fix(Lexer202320.allPrefixes(allSymbols)));
      $line=94;
      preKW=$cast(ISet.class,$fix(Lexer202320.allPrefixes(keyWords)));
      $line=95;
      ...
      $line=107;
      Object \u03A3=$fix($opUnionY($opUnionY($opUnionY(alphaNum,Lexer202320.charsStrings(allSymbols)),skipChars),GCollections.asSet(':','-')));
      $line=110;
      Object q_0=$fix("INIT");
      $line=111;
      Object F=$fix(GCollections.asSet("INIT"));
      $line=112;
      $result=$invokeConstructor(GDeterministicTransducer.class,new Object[]{Q,\u03A3,Out,q_0,F,new GMethod(Lexer202320.class,"\u03B4"),new GMethod(Lexer202320.class,"g"),new GMethod(Lexer202320.class,"h")});
      if (true) break $try;
      $line=113;
      $rethrow(new RuntimeException("The function \"createLexer()\" did not return a value."));
    }
    catch (Throwable $throwable) {
      $rethrow($throwable,Lexer202320.class,"createLexer",$line);
    }
  ...
  public static Object \u03B4(Object state, Object \u03C3) {
    ...
    $try:try {
      ...
      if ($opEqualY(q,"Err")) {
        ...
        if ($opMembrY(q,preOps)) {
          ...
          if ($opMembrY($opAdditY(q,\u03C3),preOps)) {
            ...
            $line=124;
            if ($bool(Lexer202320.problems($cast(java.lang.String.class,q)))) {
              $line=124;
              $result="Err";
              if (true) break $try;
            }
      ...
      $rethrow($throwable,Lexer202320.class,"\u03B4",$line);
    }
    return $result;
  }
  public static Object g(Object q) {
    ...
    $try:try {
      ...
      $rethrow($throwable,Lexer202320.class,"g",$line);
    }
    return $result;
  }
  public static Object h(Object q, Object \u03C3) {
    ...
    $try:try {
      ...
      if ($opMembrY(q,preOps)) {
          ...
          if ($opMembrY($opAdditY(q,\u03C3),preOps)) {
            ...
            if (($opMembrY(\u03C3,$opUnionY(StartOps,alphaNum))&&$opMembrY(q,allSymbols))) {
              ...
              if ($opMembrY(\u03C3,$opUnionY($opUnionY($opUnionY(StartOps,alphaNum),skipChars),GCollections.asSet(':')))) {
                ...
                currentString=$cast(String.class,$fix($opAdditY("",s)));
                $line=178;
                $result=Lexer202320.translationPreOps(q);
                if (true) break $try;
              }
              else {
                $line=180;
        ...
        if ((!$opMembrY(q,GCollections.asSet("Err"))&&$opMembrY(\u03C3,$opUnionY(skipChars,StartOps)))) {
          ...
          if ($opEqualY(q,"INIT")) {
            ...
            $line=189;
            if ($opEqualY(Lexer202320.translationGet(q),null)) {
              $line=191;
              ((gold.structures.list.GArrayList)images).add(currentString);
              $line=192;
              ...
              if ($opMembrY(f,alphaUpper)) {
                $line=194;
                $result=Lexer202320.translationGet("IdU");
                if (true) break $try;
              }
              else {
                $line=195;
                if ($opMembrY(f,alphaLower)) {
                  $line=196;
                  $result=Lexer202320.translationGet("IdL");
                  if (true) break $try;
                }
                else {
                  $line=197;
      ...
      $rethrow($throwable,Lexer202320.class,"h",$line);
    }
    return $result;
  }
  public static Object initialize() {
    ...
    $try:try {
      ...
      $line=221;
      keyWords=$cast(ISet.class,$fix(GCollections.asSet("leap","turnto","north","defvar","defproc","jump","walk","turn","turnto","drop","get","grab","letgo","nop","if","else","while","repeat","times","facing","can","not","front","right","left","back","north,","south","east","west")));
      $line=224;
      allSymbols=$cast(ISet.class,$fix(GCollections.asSet("{","}","(",")",":",";",",")));
      $line=244;
      ((gold.structures.map.GHashTableMap)translation).put("defvar",'V');
      $line=245;
      ((gold.structures.map.GHashTableMap)translation).put("defproc",'P');
      $line=248;
      ((gold.structures.map.GHashTableMap)translation).put("walk",'w');
      $line=249;
      ((gold.structures.map.GHashTableMap)translation).put("turnto",'T');
      $line=250;
      ((gold.structures.map.GHashTableMap)translation).put("turn",'t');
      $line=251;
      ((gold.structures.map.GHashTableMap)translation).put("nop",'N');
      $line=254;
      ((gold.structures.map.GHashTableMap)translation).put("drop",'p');
      $line=255;
      ((gold.structures.map.GHashTableMap)translation).put("get",'p');
      $line=257;
      ((gold.structures.map.GHashTableMap)translation).put("grab",'g');
      $line=258;
      ((gold.structures.map.GHashTableMap)translation).put("letgo",'g');
      $line=261;
      ((gold.structures.map.GHashTableMap)translation).put("leap",'j');
      $line=262;
      ...
      $line=269;
      ((gold.structures.map.GHashTableMap)translation).put("times",'t');
      $line=272;
      ((gold.structures.map.GHashTableMap)translation).put("facing",'q');
      $line=273;
      ((gold.structures.map.GHashTableMap)translation).put("can",'c');
      $line=274;
      ((gold.structures.map.GHashTableMap)translation).put("not",'n');
      $line=277;
      ((gold.structures.map.GHashTableMap)translation).put("north",'h');
      $line=278;
      ((gold.structures.map.GHashTableMap)translation).put("south",'h');
      $line=279;
      ((gold.structures.map.GHashTableMap)translation).put("east",'h');
      $line=280;
      ((gold.structures.map.GHashTableMap)translation).put("west",'h');
      $line=282;
      ((gold.structures.map.GHashTableMap)translation).put("front",'l');
      $line=283;
      ((gold.structures.map.GHashTableMap)translation).put("back",'L');
      $line=284;
      ((gold.structures.map.GHashTableMap)translation).put("right",'o');
      $line=285;
      ((gold.structures.map.GHashTableMap)translation).put("left",'O');
      $line=287;
      ...
      $rethrow($throwable,Lexer202320.class,"initialize",$line);
    }
    return $result;
  }
}
