...
public final class Lexer202310 {
  ...
  public static Object initialize() {
    ...
    $try:try {
      ...
      $line=221;
      keyWords=$cast(ISet.class,$fix(GCollections.asSet("moveToThe","face","north","ROBOTR","VARS","PROCS","assignTo","goto","move","turn","face","put","pick","moveToThe","moveInDir","jumpToThe","jumpInDir","nop","if","then","else","while","do","repeat","facing","canPut","canPick","canMoveInDir","canJumpInDir","canMoveToThe","canJumpToThe","not","chips","balloons","front","right","left","back","north,","south","east","west","around")));
      $line=227;
      allSymbols=$cast(ISet.class,$fix(GCollections.asSet("[","]","|",":",";",",")));
      $line=242;
      ((gold.structures.map.GHashTableMap)translation).put("ROBOTR",'R');
      $line=243;
      ...
      $line=259;
      ((gold.structures.map.GHashTableMap)translation).put("moveToThe",'j');
      $line=260;
      ((gold.structures.map.GHashTableMap)translation).put("jumpToThe",'j');
      $line=262;
      ((gold.structures.map.GHashTableMap)translation).put("moveInDir",'M');
      $line=263;
      ((gold.structures.map.GHashTableMap)translation).put("jumpInDir",'M');
      $line=267;
      ...
      $line=278;
      ((gold.structures.map.GHashTableMap)translation).put("canPut",'k');
      $line=279;
      ((gold.structures.map.GHashTableMap)translation).put("canPick",'k');
      $line=282;
      ((gold.structures.map.GHashTableMap)translation).put("canMoveInDir",'w');
      $line=283;
      ((gold.structures.map.GHashTableMap)translation).put("canJumpInDir",'w');
      $line=285;
      ((gold.structures.map.GHashTableMap)translation).put("canMoveToThe",'s');
      $line=286;
      ((gold.structures.map.GHashTableMap)translation).put("canJumpToThe",'s');
      $line=287;
      ((gold.structures.map.GHashTableMap)translation).put("not",'n');
      $line=291;
      ((gold.structures.map.GHashTableMap)translation).put("chips",'c');
      $line=292;
      ((gold.structures.map.GHashTableMap)translation).put("balloons",'c');
      $line=295;
      ...
      $line=300;
      ((gold.structures.map.GHashTableMap)translation).put("around",'Y');
      $line=301;
